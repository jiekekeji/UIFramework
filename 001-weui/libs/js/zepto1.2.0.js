...
!function (a) {
    ...
    a.toast = function (a, b) {
        ...
        d()
    }, e = a.toast.prototype.defaults = {duration: 2e3}
}($), +function (a) {
    "use strict";
    var b;
    a.modal = function (c) {
        ...
        return "function" == typeof d && (e = arguments[1], d = void 0), a.modal({
            text: c,
            title: d,
            buttons: [{text: b.buttonOK, className: "primary", onClick: e}]
        })
    }, a.confirm = function (c, d, e, f) {
        return "function" == typeof d && (f = arguments[2], e = arguments[1], d = void 0), a.modal({
            text: c,
            title: d,
            buttons: [{text: b.buttonCancel, className: "default", onClick: f}, {
                text: b.buttonOK,
                className: "primary",
                onClick: e
            }]
...
;(function ($) {
    $.fn.searchBar = function (options) {
        options = $.extend({focusingClass: 'weui_search_focusing', searchText: "搜索", cancelText: "取消"}, options);
...
(function ($) {
    ...
    $.fn.tab = function (options) {
        options = $.extend({defaultIndex: 0, activeClass: 'weui_bar_item_on', onToggle: $.noop}, options);
